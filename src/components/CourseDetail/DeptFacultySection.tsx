    ...
    return (
        <section className="w-full bg-white py-12 md:py-20 4xl:py-36 flex justify-center px-4 md:px-10 lg:px-20">
            <div className="w-full max-w-7xl 3xl:max-w-[1600px] 4xl:max-w-[2000px] flex flex-col items-center">
                ...
                {/* Title */}
                <h1 className="text-heroText text-navy-900 text-center capitalize leading-tight mb-6 4xl:mb-12 font-heading font-normal">
                    Our Faculty
                </h1>

                {/* Description */}
                <h2 className={`${inter.className} font-light text-subText text-navy-800 text-center max-w-3xl 4xl:max-w-5xl mx-auto mb-10 4xl:mb-20`}>
                ...
                <div className="flex justify-center mt-12 4xl:mt-24">
                    <CTAButton text='View All Faculty' />
                </div>
            </div>
        </section>
