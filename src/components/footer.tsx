...
function Footer() {
  return (
    <motion.footer className="relative bg-[#0275B8] text-white pt-16 pb-0 overflow-hidden border-none shrink-0 z-50">
      ...
      {/* pattern */}
      <img src="footerSvg.svg" alt="" className="absolute -top-10 object-cover w-full h-full -z-10 pointer-events-none opacity-[0.15]" />
      <img src="footerSvg2.svg" alt="" className="absolute top-0 object-cover w-full h-full -z-20 pointer-events-none opacity-[0.14]" />
      <img src="footerSvg3.svg" alt="" className="absolute top-16 object-cover w-full h-full -z-20 pointer-events-none opacity-[0.8]" />
      <img src="footerSvg3.svg" alt="" className="absolute top-48 object-cover w-full h-full -z-30 pointer-events-none opacity-[0.2]" />
    </motion.footer>
  );
}
