                ...
                <div className="max-w-2xl w-full">
                    ...
                    <div className="flex flex-row justify-start items-center mb-16 relative gap-4 sm:gap-0">
                        ...
                        <div className="flex flex-col items-start w-1/2 sm:w-[45%]">
                            <span className={`${marcellus.className} text-4xl sm:text-5xl lg:text-6xl font-light text-[#0277bd] leading-none mb-4`}>104 +</span>
                        ...
                        {/* Stat 2 */}
                        <div className="flex flex-col items-start w-1/2 sm:w-[45%]">
                            <span className={`${marcellus.className} text-4xl sm:text-5xl lg:text-6xl font-light text-[#0277bd] leading-none mb-4`}>206+</span>
