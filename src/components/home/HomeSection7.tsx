        ...
        <section className="w-full flex flex-col lg:flex-row bg-[#FAFAFA] overflow-hidden h-fit">
            ...
            <div className="w-full lg:w-1/2 grid grid-cols-2 gap-0 content-start">
                {cards.map((card, idx) => (
                    ...
                    >
                        ...
                        <div className="absolute top-4 left-4 lg:top-6 bg-white justify-center items-center flex lg:left-6 z-20 w-[131px] 3xl:w-[160px] 4xl:w-[220px] h-[60px] 3xl:h-[80px] 4xl:h-[110px] rounded-[5px]">
                        ...
                        <div className="relative z-20">
                            ...
                            <div className="font-heading bg-gradient-to-r from-white/55 to-white/50 backdrop-blur-sm rounded-[5px] p-2.5 sm:p-2 4xl:p-6 shadow-sm inline-block min-w-[110px] sm:min-w-[150px] 4xl:min-w-[300px] border border-white/40">
                                <h3 className={`text-sm sm:text-lg 3xl:text-xl 4xl:text-3xl font-medium text-gray-900 leading-tight`}>{card.name}</h3>
                                <p className="text-[11px] sm:text-[13px] 3xl:text-base 4xl:text-2xl text-[#0277bd] mt-0.5">{card.role}</p>
                            </div>
                        </div>
                    </div>
                ))}
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center py-12 md:py-16 4xl:py-32 px-4 md:px-10 lg:px-20 3xl:px-32 4xl:px-48 overflow-hidden">
                <div className="max-w-2xl 3xl:max-w-4xl 4xl:max-w-6xl w-full">
                    {/* Header Text */}
                    <h2 className="text-3xl md:text-4xl lg:text-[44px] 3xl:text-[54px] 4xl:text-[80px] text-[#1F1F1F] leading-tight mb-6 4xl:mb-12">
                        Placement Partners
                    </h2>
                    <p className="text-[#595959] text-sm md:text-base 3xl:text-xl 4xl:text-2xl leading-relaxed mb-10 4xl:mb-20 max-w-[90%]">
                    ...
                    <div className="flex flex-row justify-start items-center mb-16 4xl:mb-24 relative gap-4 sm:gap-0">
                        ...
                        <div className="flex flex-col items-start w-1/2 sm:w-[45%]">
                            <span className="font-heading text-4xl sm:text-5xl lg:text-6xl 3xl:text-7xl 4xl:text-[7rem] font-light text-[#0277bd] leading-none mb-4 4xl:mb-8">104 +</span>
                            <span className="font-heading bg-[#FFD812] text-black px-3 sm:px-4 py-1 sm:py-1.5 4xl:px-8 4xl:py-3 rounded-md text-xs sm:text-sm 3xl:text-lg 4xl:text-2xl font-medium">Companies</span>
                            <p className="text-gray-500 text-[10px] sm:text-sm 3xl:text-base 4xl:text-xl mt-4 leading-tight max-w-[180px] 4xl:max-w-[300px]">2023–24 Campus Placement Drive</p>
                        </div>
                        ...
                        {/* Stat 2 */}
                        <div className="flex flex-col items-start w-1/2 sm:w-[45%]">
                            <span className="font-heading text-4xl sm:text-5xl lg:text-6xl 3xl:text-7xl 4xl:text-[7rem] font-light text-[#0277bd] leading-none mb-4 4xl:mb-8">206+</span>
                            <span className="font-heading bg-[#FFD812] text-black px-3 sm:px-4 py-1 sm:py-1.5 4xl:px-8 4xl:py-3 rounded-md text-xs sm:text-sm 3xl:text-lg 4xl:text-2xl font-medium">Placements</span>
                            <p className="text-gray-500 text-[10px] sm:text-sm 3xl:text-base 4xl:text-xl mt-4 leading-tight max-w-[180px] 4xl:max-w-[300px]">Offers Extended To Our Talented Graduates</p>
                        </div>
                    </div>
