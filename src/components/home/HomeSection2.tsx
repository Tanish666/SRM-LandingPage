    ...
    return (
        <section className="py-24 px-6 md:px-20 max-w-[1450px] mx-auto overflow-hidden">
            ...
            <div className="flex flex-col items-center text-center mb-10 md:mb-20">
                ...
                <h2 className={`${marcellus.className} text-4xl md:text-5xl lg:text-[45px] text-black mb-8 leading-tight lg:whitespace-nowrap text-center w-full max-w-none font-medium`}>
