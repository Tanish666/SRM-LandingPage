        ...
        <section className="py-12 md:py-20 3xl:py-32 4xl:py-48 w-full flex justify-center px-4 md:px-10 lg:px-20 3xl:px-32 4xl:px-48 overflow-hidden">
            <div className="max-w-7xl 3xl:max-w-[1600px] 4xl:max-w-[2000px] w-full flex flex-col items-center">
                ...
                <div className="relative">
                    ...
                    <div className="hidden xl:block absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 z-30 4xl:scale-125">
                        <CTAButton
                            text="Read More"
                    ...
                    {/* Cards Grid */}
                    <div className="grid grid-cols-2 xl:flex xl:flex-nowrap justify-center sm:place-items-center gap-x-4 gap-y-10 md:gap-x-10 md:gap-y-12 xl:gap-20 4xl:gap-32 max-w-6xl 3xl:max-w-7xl 4xl:max-w-[1600px] mx-auto px-4 md:px-0">
                        ...
                        <div className="xl:translate-y-20 4xl:translate-y-32 flex justify-center w-full">
                            <Card
                                number="100+"
...
const Card = ({ number, text, imageSrc, className }: { number: string, text: string, imageSrc: string, className?: string }) => (
    <div className={`group relative rounded-2xl overflow-hidden bg-slate-100 cursor-pointer w-[221.88px] md:w-[250px] lg:w-[220px] 3xl:w-[280px] 4xl:w-[380px] aspect-[221/231] md:h-[231.89px] 3xl:h-[290px] 4xl:h-[400px] ${className || ''}`}>
        {/* Background Image */}
        <Image
            src={imageSrc}
            alt={text}
