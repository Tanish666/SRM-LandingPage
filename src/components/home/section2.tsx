    ...
    <motion.div className='relative  h-screen w-full bg-[#EFEFEF] flex flex-col justify-center items-center p-10 overflow-hidden z-50'>
      ...
      <motion.div
        ...
        <motion.div
          ...
          className='size-12 rounded-full bg-white p-1 overflow-hidden flex justify-center items-center'><img loading="lazy" decoding="async" src="https://photoheads.co.uk/wp-content/uploads/2020/05/headshot-with-client-testimonial.jpg" alt="" className='object-cover h-full w-full rounded-full' /></motion.div>
