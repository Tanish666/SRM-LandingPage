                            ...
                            <AnimatePresence mode="popLayout">
                                ...
                                >
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent p-4 flex flex-col justify-end">
                                        <h4 className={`${marcellus.className} text-white font-extralight text-[20px] leading-tight`}>{getInsightAt(-1).name}</h4>
                                ...
                                >
                                    <Image src={getInsightAt(1).image} alt="Student" fill className="object-cover grayscale group-hover:grayscale-0 transition-all duration-500" />
                                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent p-4 flex flex-col justify-end">
                                        <h4 className={`${marcellus.className} text-white  text-[20px] leading-tight`}>{getInsightAt(1).name}</h4>
                                        <p className="text-white/80 text-[10px] mt-0.5 truncate">{getInsightAt(1).program}</p>
                                    </div>
                                </motion.div>
                            </AnimatePresence>
