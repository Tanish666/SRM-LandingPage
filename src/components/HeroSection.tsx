...
const HeroSection = () => {
    return (
        <section className='relative h-[85vh] flex items-center bg-[url("/HeroSectionBg.gif")] bg-cover bg-center px-6 md:px-20 overflow-hidden mx-6 md:mx-5 rounded-[1.5rem] mt-3'>
