                ...
                <div className="bg-white rounded-brand-md 4xl:rounded-brand-lg px-6 py-10 md:px-12 md:py-12 4xl:px-24 4xl:py-24 flex-1 flex flex-col relative overflow-hidden group hover:shadow-2xl transition-shadow">
                    <div className="relative z-10">
                        <div className="flex items-center gap-4 md:gap-8 4xl:gap-16 mb-6 md:mb-10 4xl:mb-20">
                            ...
                            <h3
                                className={"text-h3 md:text-h2 lg:text-h1 3xl:text-6xl 4xl:text-display-1 text-navy-900 capitalize font-heading font-normal leading-none"}
                            >
                                Vision
                            </h3>
                        </div>
                        <p
                            className={`${inter.className} text-navy-800/70 capitalize text-sm md:text-base 3xl:text-xl 4xl:text-3xl leading-relaxed 4xl:leading-[1.6] max-w-lg 4xl:max-w-5xl`}
                        >
