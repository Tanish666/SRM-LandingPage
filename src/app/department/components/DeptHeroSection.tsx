...
const AboutHero = () => {
    return (
        <section className="relative w-full h-[300px] md:h-[400px] flex items-center justify-start overflow-hidden px-4 md:px-20 mt-5">
            ...
            <div className="absolute z-20 flex flex-col items-start max-w-7xl w-full bottom-8 md:bottom-14 px-4 md:px-0">
                <h1 className={`${marcellus.className} text-white text-4xl md:text-5xl lg:text-7xl mb-4 md:mb-6 font-light`}>
                    Cardiac Care Technology
                </h1>
                <div className={`${inter.className} flex flex-wrap items-center gap-2 bg-white/95 rounded-2xl md:rounded-full px-4 py-2 md:px-5 md:py-3 shadow-sm font-normal text-xs md:text-base`}>
