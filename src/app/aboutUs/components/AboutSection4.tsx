...
const AboutSection4 = () => {
    return (
        <section className="relative mx-auto w-full px-4 md:px-10 lg:px-20 mt-10 mb-10">
            <div className="bg-gradient-to-r from-[#0071BC] to-[#33AEFF] rounded-[30px] p-8 md:p-12 lg:p-16 w-full flex flex-col lg:flex-row gap-8 lg:gap-12 shadow-xl h-full">
                ...
                <div className="bg-white rounded-[30px] px-6 py-8 md:px-10 md:py-10 flex-1 flex flex-col relative overflow-hidden">
                    <div className="relative z-10">
                        ...
                        <p className={`${inter.className} text-[#515151] capitalize text-sm md:text-base leading-relaxed max-w-lg`}>
