            ...
            <div className="flex flex-col lg:flex-row gap-16 lg:items-stretch">
                ...
                <div className="w-full lg:w-[42%] relative shrink-0">
                    ...
                    <div className="absolute bottom-0 left-0 w-[90%] md:w-[89%]  rounded-tr-[50px] md:rounded-tr-[30px] flex items-center gap-5 md:gap-8 overflow-hidden pt-4">
                        ...
                        <span className={`${marcellus.className} text-lg md:text-2xl text-[#1E1E1E] whitespace-nowrap`}>
                ...
                <div className="w-full lg:flex-1 flex flex-col items-start justify-center mt-8 lg:mt-0">
                    <div className="flex items-center gap-3 border border-slate-300 px-6 py-2 rounded-full mb-8 bg-[#DBDBDB]/80 shrink-0 shadow-sm">
                        <span className="size-2.5 bg-[#0091FF] rounded-full"></span>
                        <span className="text-base font-medium text-slate-700">About Us</span>
                    </div>

                    <div className={`${marcellus.className} text-3xl md:text-[45px] text-slate-900 mb-6 leading-[1.2]`}>
                        <p>Shaping Healthcare Leaders</p>
                        <p>For A Better Tomorrow</p>
                    </div>

                    <p className="text-slate-500 text-base md:text-[17px] leading-relaxed mb-5 font-normal">
                    ...
                    <p className="text-slate-500 text-base md:text-[17px] leading-relaxed mb-8 font-normal">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-8 w-full">
                        <div className="flex items-center gap-4">
                            ...
                            <div className={`${marcellus.className} text-2xl leading-tight text-slate-900`}>
                                Year of<br />Legacy
                            </div>
                        </div>

                        <div className="hidden sm:block w-[2.5px] h-20 bg-slate-200"></div>

                        <div className="flex items-center gap-4">
                            <span className={`${marcellus.className} text-[#0091FF] text-6xl leading-none`}>18+</span>
                            <div className={`${marcellus.className} text-2xl leading-tight text-slate-900`}>
