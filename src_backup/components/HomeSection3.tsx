        ...
        <section className="py-10 px-6 md:px-20 max-w-[1450px] mx-auto overflow-hidden">
            <div className="grid grid-cols-1 xl:grid-cols-[1fr_0.8fr_1.5fr] gap-12 xl:gap-8 items-center max-w-7xl mx-auto">
                ...
                <div className="flex flex-col items-start">
                    ...
                    <h2 className={`font-display text-4xl md:text-5xl xl:text-5xl text-foreground leading-[1.2] mb-10 w-full xl:w-[80%] xl:text-nowrap`}>
                ...
                <div className="flex justify-center w-full">
                    <div className="relative w-full max-w-80 aspect-[4/5] rounded-[2rem] overflow-hidden shadow-lg group">
                        <Image
                ...
                <div className="flex flex-col pl-0 xl:pl-10">
                    ...
                    <div className='w-full flex justify-center items-center md:justify-start'>
                        <div className="flex bg-[#FCF01E] rounded-full p-2 mb-8 w-fit shrink-0">
                            <button
                                className={`px-5 py-2.5 rounded-full text-base font-medium transition-all ${activeTab === 'Under Graduate' ? 'bg-background text-[#0071BC] shadow-sm leading-none' : 'text-foreground hover:bg-white/50 leading-none'}`}
                                onClick={() => {
                            ...
                            <button
                                className={`px-5 py-2.5 rounded-full text-base font-medium transition-all ${activeTab === 'Post Graduate' ? 'bg-background text-[#0071BC] shadow-sm leading-none' : 'text-foreground hover:bg-white/50 leading-none'}`}
                                onClick={() => {
                    ...
                    <div className="relative">
                        <div className="flex flex-col h-80 overflow-y-auto pr-6 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-slate-100 [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-thumb]:bg-[#FCF01E] [&::-webkit-scrollbar-thumb]:rounded-full">
                            {(activeTab === 'Under Graduate' ? ugPrograms : pgPrograms).map((program) => {
                                ...
                                <Link
                                    ...
                                    className={`group flex items-center justify-between py-5 border-b cursor-pointer transition-colors ${isActive ? 'border-slate-800 text-[#0071BC]' : 'border-slate-200 text-muted-foreground hover:text-[#0071BC]'
                                        }`}
                                >
                                    <span className={`font-display text-2xl transition-colors truncate max-w-full xl:max-w-80 xl:whitespace-nowrap ${isActive ? 'text-[#0071BC]' : 'text-foreground group-hover:text-[#0071BC]'}`}>{program.name}</span>
                                    <svg
                                        width="30"
                                        height="30"
                                        viewBox="0 0 30 30"
