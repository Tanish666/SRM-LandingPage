    ...
    <motion.footer className="relative bg-[#0275B8] text-white pt-16 pb-0 overflow-hidden border-none shrink-0 z-50">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 pb-12">
        ...
        <div className="flex flex-col gap-6">
          ...
          <p className="text-[#E0F2FE] text-base leading-relaxed pr-4 font-light">
        ...
        <div className="lg:pl-6">
          <h4 className="font-serif text-2xl sm:text-3xl mb-6 text-[#F8FAFC]">Quick Link</h4>
          <ul className="space-y-4 text-base text-[#E0F2FE] font-light">
        ...
        {/* Column 3: Academics */}
        <div>
          <h4 className="font-serif text-2xl sm:text-3xl mb-6 text-[#F8FAFC]">Academics</h4>
          <ul className="space-y-4 text-base text-[#E0F2FE] font-light">
        ...
        {/* Column 4: Contact Us */}
        <div>
          <h4 className="font-serif text-2xl sm:text-3xl mb-6 text-[#F8FAFC]">Contact Us</h4>
          <div className="space-y-6 text-base text-[#E0F2FE] font-light">
            <div className="flex gap-4 items-start">
              <FaLocationDot className="text-yellow-400 text-2xl shrink-0 mt-1" />
      ...
      <div className="relative z-10 w-full flex flex-col items-center justify-center">
        ...
        >
          <div
            className="bg-background text-foreground text-xs sm:text-xs md:text-sm py-2 px-12 md:px-24 lg:w-[1100px] flex items-center justify-center text-center font-semibold"
            style={{
