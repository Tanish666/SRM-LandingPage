...
const HomeSection10 = ({ newsEventsData = [] }: { newsEventsData?: NewsEvent[] }) => {
    ...
    return (
        <section className="w-full bg-background py-16 px-4 md:px-8 lg:px-16 overflow-hidden font-sans">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mb-20">
                    <div className="flex flex-col items-center relative mb-12">
                        ...
                        {/* Heading */}
                        <h2 className={`text-3xl md:text-5xl font-serif text-center text-gray-900 leading-tight font-display`}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:h-96 h-auto">
                        {/* Calendar Card */}
                        <div className="bg-[#C5E6FD] rounded-xl p-6 text-gray-800">
                            <div className="flex items-center justify-center gap-4 text-lg font-serif mb-6">
                                <span className={`font-display text-2xl`}>{monthNames[currentMonth.getMonth()]}</span>
                            </div>
                            <div className='w-full h-px border-t my-5 border-dashed border-[#9F9F9F]' />
                            <div className="grid grid-cols-8 gap-y-4 gap-x-2 text-base md:text-sm lg:text-sm text-center font-medium">
                            ...
                            {displayEvents.slice(startIndex, startIndex + 2).map((event) => (
                                ...
                                >
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <h3 className={`font-display text-xl font-serif text-gray-900 leading-tight`}>
                                            {event.title}
                                        </h3>
                ...
                {/* Bottom Section */}
                <div className="mt-24">
                    <h2 className={`text-3xl md:text-4xl font-serif text-center text-gray-900 mb-12 font-display`}>
                        Start Your Journey Today!
                    </h2>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
                        {/* Card 1 */}
                        <div className="bg-[#A4DEFF] rounded-3xl h-60 flex flex-col items-center justify-center p-6 relative group cursor-pointer hover:-translate-y-1 transition-transform">
                            <div className="w-14 h-14 bg-background rounded-full flex items-center justify-center shadow-md mb-8 group-hover:scale-110 transition-transform">
                                <IconArrowNarrowRight className="text-gray-900 -rotate-[35deg]" size={40} strokeWidth={1.5} />
                            </div>
                            <div className="bg-background rounded-full py-2.5 px-8 shadow-sm text-sm font-medium text-gray-800">
                                Connect With Us
                            </div>
                        </div>

                        {/* Card 2 */}
                        <div className="bg-[#FFF3B0] rounded-3xl h-60 flex flex-col items-center justify-center p-6 relative group cursor-pointer hover:-translate-y-1 transition-transform">
                            <div className="w-14 h-14 bg-background rounded-full flex items-center justify-center shadow-md mb-8 group-hover:scale-110 transition-transform">
                                <IconArrowNarrowRight className="text-gray-900 -rotate-[35deg]" size={40} strokeWidth={1.5} />
                            </div>
                            <div className="bg-background rounded-full py-2.5 px-8 shadow-sm text-sm font-medium text-gray-800">
                        ...
                        {/* Card 3 */}
                        <div className="bg-[#E0E0E0] rounded-3xl h-60 flex flex-col items-center justify-center p-6 relative group cursor-pointer hover:-translate-y-1 transition-transform">
                            <div className="w-14 h-14 bg-background rounded-full flex items-center justify-center shadow-md mb-8 group-hover:scale-110 transition-transform">
                                <IconArrowNarrowRight className="text-gray-900 -rotate-[35deg]" size={40} strokeWidth={1.5} />
                            </div>
                            <div className="bg-background rounded-full py-2.5 px-8 shadow-sm text-sm font-medium text-gray-800">
