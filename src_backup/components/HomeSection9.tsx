        ...
        <section className="flex flex-col lg:flex-row w-full bg-[#3EA1FF] min-h-[100vh]">
            ...
            <div className="w-full lg:w-[45%] relative min-h-[600px] lg:min-h-screen flex items-end bg-gray-300 overflow-hidden">
                ...
                <div className="relative w-full pt-10 pb-16 px-8 lg:px-14 flex flex-col items-start gap-4 z-10">
                    <div className='absolute top-0 left-0 w-full h-full bg-background backdrop-blur-sm -z-10' />
                    <h2 className={`text-4xl md:text-5xl lg:text-6xl font-display leading-[1.1] text-foreground font-serif tracking-tight`}>
                        World Class Facilities
                    </h2>
                    <p className="text-gray-900 text-base md:text-base max-w-[95%] leading-relaxed font-medium mt-2">
                    ...
                    <button className="mt-6 bg-[#FFD100] hover:bg-[#E6BC00] text-foreground font-medium text-lg rounded-full pl-8 pr-1 py-1 flex items-center gap-4 transition-all hover:scale-[1.03] active:scale-95 shadow-md">
                        <span>Explore Our Campus</span>
                        <div className="bg-background rounded-full p-2.5 flex items-center justify-center shadow-sm">
                    ...
                    <div className="hidden lg:flex gap-4 sm:gap-6 w-full h-[120vh]">
                        ...
                        <Marquee vertical className="[--duration:30s] w-1/2" repeat={4}>
                            <FacilityCard
                                title="Open Stadium"
                                imgSrc="/sec9Pic2.svg"
                                heightClass="h-52 md:h-60 xl:h-72"
                            />
                            <FacilityCard
                                title="Central Library"
                                imgSrc="/sec9Pic3.svg"
                                heightClass="h-64 md:h-80 xl:h-96"
                            />
                            <FacilityCard
                                title="Sports Complex"
                                imgSrc="/sec9Pic4.svg"
                        ...
                        <Marquee vertical reverse className="[--duration:35s] w-1/2" repeat={4}>
                            <FacilityCard
                                title="Computer Labs"
                                imgSrc="/sec9Pic5.svg"
                                heightClass="h-60 md:h-72 xl:h-80"
                            />
                            <FacilityCard
                                title="Cafeteria"
                                imgSrc="/sec9Pic6.svg"
                            ...
                            <FacilityCard
                                title="Modern Campus"
                                imgSrc="/sec9Pic7.svg"
                                heightClass="h-44 md:h-56 xl:h-60"
                            />
                        </Marquee>
                    </div>
...
const FacilityCard = ({ title, heightClass, imgSrc, widthClass = "w-full" }: { title?: string, heightClass: string, imgSrc: string, widthClass?: string }) => (
    <div className={`relative ${widthClass} ${heightClass} rounded-xl overflow-hidden shadow-xl group bg-blue-950 transition-all duration-300 hover:shadow-2xl`}>
        ...
        <div className="absolute inset-x-0 bottom-0 h-[55%] bg-gradient-to-t from-black/95 via-black/40 to-transparent flex items-end justify-center pb-5 sm:pb-6 pointer-events-none">
            ...
            {title && (
                <div className="flex items-center w-full px-4 sm:px-6 gap-3">
                    <div className="h-0.5 flex-1 bg-[#FFD100]"></div>
                    <span className="text-white text-sm sm:text-base lg:text-base font-medium lg:whitespace-nowrap drop-shadow-md">
                        {title}
                    </span>
                    <div className="h-0.5 flex-1 bg-[#FFD100]"></div>
                </div>
