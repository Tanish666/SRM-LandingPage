...
const Faq = () => {
    ...
    return (
        <section className="flex flex-col items-center px-6 md:px-20 py-16 w-full max-w-[1000px] mx-auto mb-10">
            <h2 className={`font-display text-2xl md:text-5xl text-gray-900 mb-10 md:mb-14 text-center`}>
                ...
                {faqs.map((faq, idx) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {isOpen && (
                                <div className="p-6 md:p-8 text-[#666] text-sm md:text-base leading-relaxed bg-[#f6f7f9] border-t border-gray-100">
                                    {faq.answer}
                                </div>
                            )}
                        </div>
