                ...
                <div className="bg-background rounded-[30px] px-6 py-8 md:px-10 md:py-10 flex-1 flex flex-col relative overflow-hidden">
                    <div className="relative z-10">
                        <div className="flex items-center gap-4 md:gap-6 mb-6 md:mb-8">
                            ...
                            <h3
                                className={`font-display text-3xl md:text-4xl lg:text-5xl text-foreground capitalize`}
                            >
                                Vision
                            </h3>
                        </div>
                        <p
                            className={`${inter.className} text-muted-foreground capitalize text-sm md:text-base leading-relaxed max-w-lg`}
                        >
