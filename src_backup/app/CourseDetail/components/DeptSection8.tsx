    ...
    return (
        <section className="w-full overflow-hidden">
            ...
            <div className="relative bg-[#F4F7FD] flex items-center justify-center py-16 lg:py-0 px-6 lg:px-0 lg:h-[637px]">
                <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-32 max-w-[1440px] mx-auto">
                    {/* Left: Blue frame */}
                    <div
                        className="flex-shrink-0 flex items-center justify-center rounded-[30px] shadow-[0_10px_35px_rgba(0,113,188,0.2)] w-80 h-96 lg:w-[408px] lg:h-[445px]"
                        style={{
                            background:
                                'linear-gradient(to right, #0071BC 0%, #33AEFF 100%)',
                        }}
                    >
                        <div className="relative overflow-hidden rounded-3xl w-64 h-72 lg:w-96 lg:h-96">
                            <Image
                                src="/depsecpic4.png"
                    ...
                    <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
                        ...
                        <h3
                            className={`font-display text-3xl lg:text-5xl text-[#0D1B2A] leading-tight mb-4`}
                        >
                            Dr.Kumar Ebenezer K
                        </h3>
                        <p
                            className={`${inder.className} text-[#0071BC] font-normal mb-8 text-2xl lg:text-4xl`}
