...
const DeptSection11 = ({ courseData }: Props) => {
    ...
    return (
        <section className="pb-16 mt-36 md:mt-36 w-full bg-background">
            <div className="mx-auto flex flex-col items-center" style={{ maxWidth: '1440px' }}>
                <SectionPill text="Testimonials" className="mb-8" />
                {/* Title */}
                <h2
                    className={`font-display text-3xl xl:text-5xl text-foreground text-center capitalize px-4 xl:px-0 leading-[36px] xl:leading-[56px]`}
                >
                ...
                <div className="block xl:hidden px-4 mt-8 w-full max-w-[800px] mx-auto">
                    <div className="relative flex items-center justify-center w-full">
                        ...
                        <button
                            onClick={handlePrev}
                            className="absolute left-0 md:left-[5%] lg:left-[8%] z-40 p-0 border-none bg-transparent cursor-pointer w-9 h-9 md:w-12 md:h-12 hover:scale-110 transition-transform"
                        ...
                        {/* Single Card */}
                        <div className="relative mx-auto w-56 h-80 md:w-96 md:h-[460px]">
                            <AnimatePresence mode="wait">
                                ...
                                >
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/75 via-black/30 to-transparent px-4 pb-4 pt-12 md:px-6 md:pb-6 md:pt-16">
                                        <p
                                            className={`font-display text-white capitalize text-lg md:text-2xl leading-[22px] md:leading-[28px]`}
                                        >
                                            {active.name}
                                        </p>
                                        <p
                                            className={`${inter.className} text-white font-normal capitalize mt-0.5 text-xs md:text-base leading-[18px] md:leading-[22px]`}
                                        >
                                            {active.department}
                                        </p>
                                    </div>
                        ...
                        <button
                            onClick={handleNext}
                            className="absolute right-0 md:right-[5%] lg:right-[8%] z-40 p-0 border-none bg-transparent cursor-pointer w-9 h-9 md:w-12 md:h-12 hover:scale-110 transition-transform"
                    ...
                    <div
                        className="relative bg-[#FDFDFD] rounded-2xl md:rounded-3xl mt-5 md:mt-8 p-5 md:p-8 mx-auto overflow-hidden w-full max-w-96 md:max-w-[550px]"
                        style={{
                    ...
                    >
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            >
                                <p
                                    className={`${inter.className} font-normal text-[#4B4B4B] capitalize text-sm md:text-base leading-[21px] md:leading-[26px]`}
                                >
                                    {active.quote}
                                </p>
                                <p
                                    className={`font-display text-[#0071BC] mt-4 md:mt-6 text-lg md:text-2xl leading-[24px] md:leading-[32px]`}
                                >
                                    {active.name}
                                </p>
                                <p
                                    className={`${inter.className} font-normal text-[#4B4B4B] capitalize mt-0.5 text-sm md:text-base leading-[20px] md:leading-[24px]`}
                                >
                                    {active.department}
                                </p>
                            </motion.div>
                ...
                >
                    {testimonials.map((t, index) => {
                        ...
                        return (
                            <div key={`desktop-card-${index}`} style={style}>
                                <div className={`relative w-full h-full rounded-2xl overflow-hidden shadow-md transition-all duration-500 bg-black`}>
                                    <Image
                                        src={t.image}
                                        alt={t.name}
                                        fill
                                    ...
                                    <div className={`absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent transition-all duration-500 ${isCenter ? 'px-5 pb-5 pt-16' : 'px-4 pb-3 pt-12'}`}>
                                        <p
                                            className={`font-display text-white capitalize transition-all duration-500`}
                    ...
                    <AnimatePresence mode="wait">
                        <motion.div
                            ...
                            exit={{ opacity: 0, y: -10 }}
                            transition={{ duration: 0.3 }}
                            className="absolute bg-[#FDFDFD] rounded-3xl z-20 overflow-hidden"
                            style={{
                                width: '584px',
                                height: '330px',
                                left: '444px',
                        ...
                        >
                            ...
                            >
                                ...
                                <p
                                    className={`font-display text-2xl text-[#0071BC] mt-5`}
                ...
                {/* Pagination Pills */}
                <div
                    className="flex items-center justify-center mt-8 xl:mt-12 gap-2 mr-0 xl:mr-10"
                >
