            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-10 lg:gap-20 max-w-7xl">
                ...
                <div className="shrink-0 w-full md:w-auto">
                    <div className="relative w-full max-w-[462px] aspect-[462/480] mx-auto lg:mx-0">
                        ...
                        <div
                            className="absolute rounded-3xl bg-[#008EED] w-[95%] h-[95%] top-[5%] left-[5%]"
                        />

                        {/* Main Image  */}
                        <div
                            className="relative overflow-hidden z-10 w-[95%] h-[95%] rounded-xl"
                        >
                ...
                <div className="flex flex-col items-start lg:pt-5">
                    <SectionPill text="About Us" className="mb-6" />
                    {/* Title*/}
                    <h2
                        className={`font-display text-3xl md:text-4xl lg:text-5xl text-foreground capitalize mb-6 leading-tight lg:max-w-[687px]`}
                    >
                        {title}
                    </h2>
                    ...
                    {/* Body text  */}
                    <div
                        className="font-light text-base md:text-lg text-foreground flex flex-col gap-5 leading-relaxed lg:max-w-[705px] text-justify"
                    >
                        {contentHtml ? (
                    ...
                    <button
                        className="inline-flex items-center justify-between bg-[#FFEC22] transition-colors mt-8 cursor-pointer w-56 h-12 rounded-[33.57px] border border-[#E5E5E5] pl-5 pr-1 self-center lg:self-start"
                    >  <span className="text-lg font-normal text-foreground leading-none">Explore Program</span>
                        <span
                            className="rounded-full bg-background flex items-center justify-center flex-shrink-0 w-10 h-10"
                        >
