        ...
        <section className="relative w-full bg-[#FFD100] overflow-hidden">
            ...
            <div className="max-w-[1450px] mx-auto px-6 md:px-20 py-24 flex flex-col lg:flex-row gap-16 lg:gap-24 relative z-10">
                ...
                <div className="w-full lg:w-1/2 flex flex-col">
                    ...
                    <h2 className={`font-display text-4xl md:text-6xl text-foreground mb-6 md:mb-8 leading-tight`}>
                        Our Principles
                    </h2>
                    <p className="text-[#3E3E3E] text-base leading-[1.8] max-w-xl mb-8 font-normal">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut laboreLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut laboreLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore Lorem ipsum dolor sit amet,
                    </p>
                </div>
                ...
                <div className="w-full lg:w-1/2 flex flex-col gap-4">
                    {faq.map((item, idx) => (
                        <div key={idx} className="bg-background rounded-none overflow-hidden transition-all duration-300">
                            <button
                                onClick={() => setOpenIdx(openIdx === idx ? null : idx)}
                                className={`w-full text-left px-6 md:px-8 py-4 md:py-6 flex items-center justify-between font-normal text-lg md:text-2xl transition-colors font-display ${openIdx === idx ? 'bg-[#00ADEF] text-white' : 'text-[#3E3E3E] hover:bg-slate-50'}`}
                            >
                                {item.q}
                                <span>
