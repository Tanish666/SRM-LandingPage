        ...
        <section className="bg-[url('/ASec9Bg.svg')] bg-cover bg-center py-24 w-full mx-auto relative overflow-hidden">
            <div className="relative w-full p-12 lg:p-16 flex flex-col min-h-[700px]">
                ...
                <div className="flex flex-col items-center mb-12 relative z-10">
                    ...
                    <h2 className={`font-display text-white text-3xl md:text-5xl lg:text-5xl leading-tight max-w-4xl text-center`}>
                ...
                <div className="hidden sm:grid grid-cols-2 xl:grid-cols-4 gap-6 gap-y-10 relative z-10 mb-8 w-full max-w-[1300px] mx-auto px-4 lg:px-0">
                    {facilities.map((item, idx) => (
                        <div key={idx} className={`relative h-96 w-full max-w-80 mx-auto rounded-2xl overflow-hidden ${item.img} group cursor-pointer shadow-2xl hover:-translate-y-2 transition-transform duration-500`}>
                            ...
                            <div className="absolute bottom-0 left-0 right-0 z-20 h-16 backdrop-blur-[2px] flex items-center justify-center">
                                <div className="flex items-center gap-3 w-full px-4">
                                    <div className="h-0.5 w-7 shrink-0 bg-[#FFD812]" />
                                    <span className={`font-display text-white text-sm lg:text-sm  tracking-wide uppercase whitespace-nowrap`}>
                                        {item.title}
                                    </span>
                                    <div className="h-0.5 flex-grow bg-[#FFD812]" />
                                </div>
                            </div>
                        </div>
                    ))}
                ...
                <div className="flex sm:hidden items-center justify-center w-full relative z-10 mb-8 h-96">
                    <AnimatePresence mode="wait">
                        <motion.div
                            ...
                            className={`relative h-96 w-full max-w-80 mx-auto rounded-2xl overflow-hidden ${facilities[currentIndex].img} shadow-2xl`}
                        >
