        ...
        <section className="py-24 md:py-32 px-6 max-w-7xl mx-auto flex flex-col items-center">
            ...
            <div className="flex items-center justify-between w-full max-w-7xl mx-auto px-4 gap-4">
                <button 
                    ...
                    className="flex items-center justify-center text-foreground hover:text-blue-600 transition-colors shrink-0"
                >
                    <ChevronLeft className="size-10 font-thin" strokeWidth={1.5} />
                </button>

                <div className="flex-1 flex justify-center items-center py-4 relative h-48 overflow-hidden">
                    ...
                    <div className="hidden md:flex flex-wrap justify-center items-center gap-10 md:gap-24">
                        {marqueeLogos.map((logo, idx) => (
                            <div key={idx} className="w-52 flex items-center justify-center">
                                <img loading="lazy" decoding="async" src={`/${logo}`} alt={`Logo ${idx}`} className="max-w-full max-h-48 object-contain" />
                            </div>
                        ))}
                    </div>
