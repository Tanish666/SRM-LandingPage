...
const AboutSection8 = () => {
    ...
    return (
        <section ref={sectionRef} className="py-20 px-6 md:px-20 max-w-7xl mx-auto flex flex-col items-center">
            ...
            <div className={`font-display text-3xl md:text-6xl text-foreground mb-24 text-center leading-tight max-w-4xl text-foreground whitespace-normal`}>
            ...
            <div className="relative w-full max-w-5xl flex flex-col items-center">
                ...
                <div className="w-full relative flex flex-col md:flex-row mb-24">
                    <div className="w-full md:w-1/2 pl-12 md:pl-0 md:pr-14 text-left md:text-right">
                        <h3 className={`text-3xl text-foreground`}>2001</h3>
                    </div>
                    {/* Yellow Circle */}
                    <motion.div 
                    ...
                    <div className="w-full md:w-1/2 pl-12 md:pl-14 mt-4 md:mt-0">
                        <h4 className="text-2xl text-foreground font-normal mb-3" style={marcellus.style}>Empowering Generations</h4>
                        <p className="text-muted-foreground text-base leading-relaxed max-w-5xl">
                ...
                <div className="w-full relative flex flex-col md:flex-row-reverse mb-24">
                    <div className="w-full md:w-1/2 pl-12 md:pl-14 text-left">
                        <h3 className={`text-3xl text-foreground`}>2003</h3>
                    </div>
                    {/* Blue Circle */}
                    <motion.div 
                ...
                <div className="w-full relative flex flex-col md:flex-row mb-24">
                    <div className="w-full md:w-1/2 pl-12 md:pl-0 md:pr-14 text-left md:text-right">
                        <h3 className={`text-3xl text-foreground`}>2008</h3>
                    </div>
                    {/* Blue Circle */}
                    <motion.div 
                ...
                <div className="w-full relative flex flex-col md:flex-row-reverse">
                    <div className="w-full md:w-1/2 pl-12 md:pl-14 text-left">
                        <h3 className={`text-3xl text-foreground`}>2011</h3>
                    </div>
                    {/* Blue Circle */}
                    <motion.div 
