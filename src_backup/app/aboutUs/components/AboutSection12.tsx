        ...
        <section className="py-20 px-6 md:px-20 max-w-[1450px] mx-auto w-full">
            <div className="bg-gradient-to-br from-[#0071BC] to-[#0096F8] rounded-[30px] p-10 lg:p-14 flex flex-col lg:flex-row items-center justify-between gap-10 shadow-xl overflow-hidden relative">
                ...
                <div className="flex flex-col relative z-10 w-full lg:w-3/5">
                    ...
                    <h2 className={`font-display text-4xl md:text-5xl text-white leading-[1.2] mb-6`}>
                ...
                <div className="flex flex-col gap-4 relative z-10 w-full lg:w-auto shrink-0 mt-6 lg:mt-0">
                    <div className="flex flex-col gap-4">
                        ...
                        <button className="bg-[#FFF4B5] hover:bg-[#FFF4B5]/95 transition-colors text-foreground rounded-full px-12 py-4 flex items-center justify-center shadow-sm font-semibold w-full min-w-72 text-base tracking-wide uppercase">
                            Course Enquiry
                        </button>

                        <button className="bg-[#FFCC00] hover:bg-[#FFCC00]/95 transition-colors text-foreground rounded-full px-12 py-4 flex items-center justify-center shadow-sm font-bold w-full min-w-72 text-base tracking-wide uppercase">
                            Apply Now
                        </button>
                    </div>
                </div>
